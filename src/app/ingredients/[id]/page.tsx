        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm">
          ...
          <div className="flex space-x-3 mt-6">
            <button
              ...
              className={`flex-1 flex items-center justify-center py-3 px-4 rounded-2xl font-medium transition-all ${
                hasEaten
              ...
              {mockIngredients[0].stageInfo.map((info, index) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div className="bg-stone-50 rounded-xl p-4 flex flex-col space-y-3">
        ...
        <section>
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm">
            ...
            <div className="flex justify-between w-full">
              <span className="font-medium text-stone-700">主な栄養素</span>
              <div className="flex flex-wrap gap-2 ml-2">
                {mockIngredients[0].nutrition.nutrients.map(
                  (nutrient, index) => (
                    <span
                      key={index}
                      className="text-xs bg-amber-50 text-amber-600 px-2 py-1 rounded-full whitespace-nowrap"
                    >
                      {nutrient}
                    </span>
                  )
            ...
            <ul className="space-y-2">
              {mockIngredients[0].tips.map((tip, index) => (
                <li key={index} className="flex items-center">
                  ...
                  <span className="text-stone-600 text-sm">{tip}</span>
                </li>
              ))}
            </ul>
          </div>
